...
/*     */ {
	...
	/*     */ {
		...
		/* 31 */ ItemStack fogo = im.createItem(Material.getMaterial(351), "vidro", "§6Kits Secundarios", new String[0],
				1, (short) 10);
		/* 32 */ ItemStack kit2 = im.createItem(Material.getMaterial(351), "vidro", "§e§lKits",
				new String[] { "§e§lAbra os Kits Secundários" }, 1, (short) 8);
		/* 32 */ ItemStack loja = im.createItem(Material.getMaterial(351), "vidro", "§e§lLoja",
				new String[] { "§e§lAbra a Loja" }, 1, (short) 8);
		/*     */
		/*     */
		/* 71 */ ItemStack Stomper2 = im.createItem(Material.getMaterial(309), "vidro", "§e§lStomper2",
				new String[] { "§7Mate seus amigos pulando em cima deles." }, 1, (short) 0);
		ItemStack ajnin2 = im.createItem(Material.getMaterial(399), "vidro", "§e§lAjnin2",
				new String[] { "§7Puxe seus inimigos usando SHIFT." }, 1, (short) 0);
		ItemStack anchor = im.createItem(Material.ANVIL, "vidro", "§e§lAnchor2",
				new String[] { "§7Não leve knockback" }, 1, (short) 0);
		ItemStack antistomper2 = im.createItem(Material.DIAMOND_BOOTS, "vidro", "§e§lAntiStomper2",
				new String[] { "§7Não seja stompado =)" }, 1, (short) 0);
		/*     */
	...
	/*     */ {
		...
		/* 292 */ ItemStack baudofim = im.createItem(Material.getMaterial(130), "vidro", "§6§lDicas de Kits",
				new String[] { "§e§lKit Kangaroo!;-;" }, 1, (short) 0);
		/* 331 */ ItemStack Stomper2 = im.createItem(Material.getMaterial(309), "vidro", "§e§lStomper2",
				new String[] { "§7Mate seus amigos pulando em cima deles." }, 1, (short) 0);
		/*     */
