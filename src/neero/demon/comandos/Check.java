				...
				/* 54 */ org.bukkit.Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(this.plugin,
						new Runnable() {
							/*    */ public void run() {
								...
								/* 58 */ p
										.sendMessage("§7§lItem selecionado: §e§l§o" + target.getItemInHand().getType());
								/* 59 */ p.sendMessage("§7§lVida: §e§l§o" + (int) hp.getHealth());
								/* 60 */ p.sendMessage(
										"§7§lSopas: §e§l§o" + Check.getAmount(target, Material.MUSHROOM_SOUP));
 ...
 * plugins\JaapaPvP.jar!\com\Nerio\net\commands\Check.class Java compiler
