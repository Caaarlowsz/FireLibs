				...
				/*     */ {
					...
					/* 90 */ for (Entity ent : p.getNearbyEntities(numero, numero, numero)) {
						...
						/*     */ {
							...
							/*     */ }
						/*     */ }
					/* 98 */ Bukkit.getServer().broadcastMessage(ChatColor.GREEN + "Kit " + name
							+ " aplicado para jogadores em um raio de " + numero + " blocos");
					/* 99 */ p.sendMessage(ChatColor.GREEN + "Kit " + name + " aplicado para jogadores em um raio de "
							+ numero + " blocos");
					/* 100 */ return true;
					/*     */ }
				/* 102 */ return true;
 ...
 * plugins\JaapaPvP.jar!\com\Nerio\net\commands\Skit.class Java compiler
