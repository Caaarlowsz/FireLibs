...
/*     */ {
	...
	/*     */ {
		...
		/* 34 */ ItemStack pro = im.createItem(Material.getMaterial(35), "vidro", "§6§lPro",
				new String[] { "§aTer 700 Inscritos.", "§aFeedBack +100 Likes.", "§o§5Acesso a todos os kits." }, 1,
				(short) 4);
		/* 35 */ ItemStack youtuber = im.createItem(
				Material.getMaterial(35), "vidro", "§b§lYoutuber", new String[] { "§aTer 1000 Inscritos.",
						"§aFeedBack +150 Likes", "§aAcesso ao comando /fake.", "§o§5Acesso a todos os kits." },
				1, (short) 3);
		/* 36 */ ItemStack youtuberplus = im.createItem(Material.getMaterial(35), "vidro", "§3§l§oYoutuber+",
				new String[] { "§aTer 3000 Inscritos", "§aNao necessita a gravaçao , somente twittar.",
						"§aAcesso ao comando /fake.", "§aPode dar sugestoes para a aba Dica de Kits",
						"§o§5Acesso a todos os kits." },
				1, (short) 9);
		/*     */
		/*     */
	...
	/*     */ {
		...
		/* 55 */ ItemStack info = im.createItem(Material.getMaterial(399), "vidro", "§c§lInformaçoes do Servidor",
				new String[] { "§aJogadores Online: " + Bukkit.getServer().getOnlinePlayers().length }, 1, (short) 0);
		/* 55 */ ItemStack rank = im.createItem(Material.getMaterial(351), "vidro", "§aRanks", new String[0], 1,
				(short) 10);
	...
	/*     */ {
		...
		/* 75 */ ItemStack challenge = im.createItem(Material.getMaterial(327), "challenge", "§2Challenge",
				new String[0], 1, (short) 0);
		/* 76 */ ItemStack rdm = im.createItem(Material.getMaterial(354), "rdm", "§2RDM", new String[0], 1, (short) 0);
		/* 77 */ ItemStack fulliron = im.createItem(Material.getMaterial(369), "1v1", "§21v1", new String[0], 1,
				(short) 0);
	...
	/*     */ public void dontClick(InventoryClickEvent event) {
		...
		/* 99 */ if ((p.getOpenInventory().getTitle().equalsIgnoreCase("§bWarps §6ExtremePvP"))
				|| (p.getOpenInventory().getTitle().equalsIgnoreCase("§bServidor §6ExtremePvP"))) {
 ...
 * plugins\JaapaPvP.jar!\com\Nerio\net\commands\Warps.class Java compiler
